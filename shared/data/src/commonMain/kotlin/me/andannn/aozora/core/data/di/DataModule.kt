...
import me.andannn.aozora.core.pagesource.AozoraPageLayoutHelperFactory
...
val dataModule =
    module {
        ...
        singleOf(::AozoraPageLayoutHelperFactory).bind(AozoraPageLayoutHelper.Factory::class)
